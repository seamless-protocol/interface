...
const _abi = [
    ...
    inputs: [
      {
        ...
        components: [
          ...
          {
            name: 'proposalThresholdValue',
            type: 'uint256',
            internalType: 'uint256',
          },
          {
            name: 'voteNumeratorValue',
            type: 'uint256',
            internalType: 'uint256',
          },
          {
  ...
  {
    type: 'function',
    name: 'updateVoteCountNumerator',
    inputs: [
      {
        name: 'newVoteCountNumerator',
        type: 'uint256',
        internalType: 'uint256',
      },
    ],
  ...
  {
    type: 'event',
    name: 'VoteNumeratorUpdated',
    inputs: [
      {
        name: 'oldVoteNumerator',
        type: 'uint256',
        indexed: false,
        internalType: 'uint256',
      },
      {
        name: 'newVoteNumerator',
        type: 'uint256',
        indexed: false,
        internalType: 'uint256',
      },
  ...
  {
    type: 'error',
    name: 'GovernorInvalidVoteFraction',
    inputs: [
      {
        name: 'voteNumerator',
        type: 'uint256',

...
export const FixedAPYTooltipText = (
  <Trans>
    Static interest rate that is determined by Community Governance. This rate may be changed over
    time depending on the need for the GHO supply to contract/expand.{' '}
    <Link

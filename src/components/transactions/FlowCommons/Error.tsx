  ...
  return (
    <>
      ...
      >
        ...
        <Typography>
          <Trans>
            You can report incident to our <Link href="https://discord.com/invite/Uye9jCVgUp">Discord</Link>{' '}
            or <Link href="https://github.com/seamless-protocol/interface">Github</Link>.
          </Trans>
        </Typography>

...
export const FaucetTopPanel = () => {
  ...
  return (
    <TopInfoPanel
      ...
      titleComponent={
        <Box>
          <PageTitle pageTitle={<Trans>{currentMarketData.marketTitle} Faucet</Trans>} />
          <Box sx={{ width: md ? (xsm ? '320px' : '540px') : '860px' }}>
            <Typography variant="description" color="#A5A8B6">
              <Trans>
                With testnet Faucet you can get free assets to test the Seamless Protocol. Make sure

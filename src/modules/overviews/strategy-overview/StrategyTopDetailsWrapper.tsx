...
import { StrategyTopDetails } from './StrategyTopDetails';

interface StrategyTopDetailsProps {
  underlyingAsset: string;
}

export const StrategyTopDetailsWrapper = ({ underlyingAsset }: StrategyTopDetailsProps) => {
  ...
  return (
    ...
    >
      ...
      {isGho ? <GhoReserveTopDetails /> : <StrategyTopDetails underlyingAsset={underlyingAsset} />}
    </TopInfoPanel>
  );
};

...
const StrategyConfiguration = dynamic(() =>
  import('./StrategyConfiguration').then((module) => module.StrategyConfiguration)
);

export const StrategyConfigurationWrapper: React.FC<ReserveConfigurationProps> = ({ reserve }) => {
  ...
  return (
    <Paper sx={{ pt: 4, pb: 20, px: downToXsm ? 4 : 6 }}>
      ...
      {isGho ? (
        ...
        <StrategyConfiguration reserve={reserve} />
      )}
    </Paper>
  );
};
